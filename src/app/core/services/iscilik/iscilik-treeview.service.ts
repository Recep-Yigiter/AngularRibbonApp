...
export class IscilikTreeViewService {
    index = 0;
    expand = {};
    res: any;
    constructor() { }
    CreateTreeView(data: any) {
        ...
        function createTreeNode(value) {
            ...
            return {
                id: value.id,
                gunlukUretimSayisi: value.gunlukUretimSayisi,
                calisanSayisi: value.calisanSayisi,
                gunlukCalismaSaati: value.gunlukCalismaSaati,
                kisiBasiAylikBrutUcret: value.kisiBasiAylikBrutUcret,
                receteAdi:value.receteAdi,
                receteId:value.receteId,
