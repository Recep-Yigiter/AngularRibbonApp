...
@Component({
  selector: 'app-stok-card-child-add',
  templateUrl: './stok-card-child-add.component.html',
  styleUrls: ['./stok-card-child-add.component.scss']
})
export class StokCardChildAddComponent implements OnInit {
  selectBirimId: any;
  constructor(private fb: FormBuilder, @Inject(MAT_DIALOG_DATA) public data: any, private dialogRef: MatDialogRef<StokCardChildAddComponent>, private StokService: StokService) { }
